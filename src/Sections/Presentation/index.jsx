        ...
        <Box   sx={{
            ...
            <Box sx={{display:'flex',flexDirection:'column', justifyContent:'center', alignItems:'flex-start', height:'100%', width:'100%',}}>
              ...
              <TypeAnimation
                ...
                ¡ Hola ! Soy Galo, Desarrollador Full Stack e Integrador de Sistemas. Ayudo a equipos a optimizar procesos y desarrollar plataformas web con Django,
                 React y herramientas de integración como ITX y Sterling. Curioso por naturaleza, siempre aprendiendo y mejorando.
                 </Typography>
